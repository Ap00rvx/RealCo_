  ...
  return (
    ...
    <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div className="mt-4 md:mt-0">
            <h2 className="mb-4 text-4xl tracking-tight font-semibold text-gray-900">Let's create more tools and ideas that brings us together.</h2>
            ...
            <a href="mailto:info@rkrealco.com" className="inline-flex items-center text-black bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                Get in touch
