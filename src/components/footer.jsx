          ...
          <form className="w-full" onSubmit={handleSubmit}>
            ...
            >
              <input
                ...
                className="w-full border-none focus:border-transparent focus:ring-transparent sm:text-sm bg-white text-black"
              />

              <button
                className="mt-1 w-full bg-green-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0" onSubmit="{}">
                Sign Up
              </button>
            </div>
          </form>
